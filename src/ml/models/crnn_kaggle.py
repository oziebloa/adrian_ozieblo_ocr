...
from tensorflow.keras.layers import Conv2D, MaxPooling2D, Reshape, GRU, Dense
...
with open(Path(__file__).parent / 'evals/crnn_eval.txt', 'w') as f:
...
model.save(Path(__file__).parent.parent / 'trained_models/crnn.h5')
